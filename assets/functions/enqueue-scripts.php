...
function site_scripts() {
  global $wp_styles; // Call global $wp_styles variable to add conditional wrapper around ie stylesheet the WordPress way
    ...
    wp_enqueue_script( 'foundation-js', get_template_directory_uri() . '/assets/js/foundation.min.js', array( 'jquery' ), '6.2.4', true );
    ...
    wp_enqueue_style( 'site-css-icons', get_template_directory_uri() . '/assets/css/foundation-icons-min.css', array(), '', 'all' );
